...
class PathIdOpCall(OperatorBase):
    ...
    @property
    def pragmas(self) -> List[common.PathIdentifier]:
        """Operator pragmas."""
...
class AnonymousOperatorWithDataDefinition(OperatorExpression):
    ...
    def __init__(
        ...
        data_def: Union[common.Equation, "Scope"],
    ) -> None:
        super().__init__()
        self._is_node = is_node
        self._inputs = inputs
...
class ProtectedOpExpr(OperatorExpression, common.ProtectedItem):
    ...
    def __init__(self, value: str, markup: str) -> None:
        common.ProtectedItem.__init__(self, value, markup)
